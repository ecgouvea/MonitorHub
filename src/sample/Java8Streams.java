...
/**
 * Java program to demonstrate how to use Java 8 Stream API with simple * examples like filter
 * objects, transforming objects and creating subsets.
...
// Original List : [abc, , bcd, , defg, jk], filtered list : [abc, bcd, defg] USA, JAPAN, FRANCE,
